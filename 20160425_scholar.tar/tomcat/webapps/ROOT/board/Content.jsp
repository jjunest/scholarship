...
<FONT FACE="KoreanTJM" SIZE=6 color=red>D-day <%=vo.getDday()%></FONT>
</td>
</tr>
</table>
</td>
...
<tr>
<td ALIGN="CENTER"><FONT FACE="KoreanTJM" SIZE=7>재단</FONT></td>
...
<table align=center> 
<tr>
<td width =300 align = center><A HREF ="Modify.jsp?rcdno=<%=num%>"> 정보 수정 </A></td>
<td width =200 align = center><A HREF ="Delete.jsp?rcdno=<%=num%>"> 정보 삭제   </A></td>
</tr>
</table>
