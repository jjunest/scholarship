	...
	<aside id="mainMenuContainer" class = "border-box">				
		<nav class="mainMenuContainer-inner">						
			...
			<ul id = "news-category-list">
				<li><a href="mScholarship.jsp">신규장학금</a></li>
				<li><a href="mTop.jsp">인기장학금</a></li>
				<li><a href="mTotal.jsp">전체장학금</a></li>
				<li><a href="mMain.jsp">진행장학금</a></li>
...
<div id="wrap">
    <nav id="topMenu">
    <ul id="scroller">
		<li><a class="top-menu0" href="mScholarship.jsp" data-cclick="MOBILE_,SCROLLER,TODAYRECOMM,0">신규장학금</a></li>
		...
		<li><a class="top-menu3" href="mMain.jsp" data-cclick="MOBILE_,SCROLLER,TODAYRECOMM,0">진행장학금</a></li>
