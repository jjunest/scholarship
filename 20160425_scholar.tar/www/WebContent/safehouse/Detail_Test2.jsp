...
<script type="text/javascript">
      var map;
        ...
        map.zoomToExtent( mapBounds.transform(map.displayProjection, map.projection ) );
          map.panTo(new OpenLayers.LonLat(14398637.94043, 4303037.62248));
  ...
  <div class="content_sub_left"  style="padding-left:15px">
			...
			<div class="main_title">
				<div style="border-bottom: 1px solid #5370f0;">
					<span class="main_title_apt">대잠아델리아</span>
					<span class="main_title_loc">포항남구 대잠동</span>
				...
				<div style="background-color:#eef1fe; height: 60px;">
					...
					매매 
						...
						<span style="padding-left:5px;">26,500</span> 만원
						...
						<div style="padding:10px 10px 10px 20px">
							<table class="detail_table" style="width:450px">
								<tbody><tr>
									...
									<td style="width:190px">26,500만원 </td>
					...
					<div style="border-top:1px solid #eaeaea; padding:10px 10px 10px 20px">
						<table class="detail_table">
							<tbody><tr>
								...
								<td colspan="3">올 확장되어있는 아주 깨끗하고 넓은 집입니다. </td>
							</tr>
						</tbody></table>
					</div>		
				</div>	
        ...
        mapOption = {
        center: new daum.maps.LatLng(36.0177993,129.3453480), // 지도의 중심좌표
        level: 3 // 지도의 확대 레벨
        };
        ...
        // 마커가 표시될 위치입니다
	var markerPosition  = new daum.maps.LatLng(36.0177993,129.3453480);
					...
					<div style="border-right:1px solid #eaeaea; padding:20px; padding-top:10px;">
						<table class="detail_table" style="">
							<tbody><tr>
								...
								<td colspan="5">포항남구 대잠동 경북 포항시 남구 대이로20번길 20 (대잠동 970)</td>
							</tr>
							...
							<tr height="25">
								...
								<td style="width:140px">115㎡ (35평)</td>
								<td class="cat" style="width:90px">총동수</td>
								<td style="width:160px">3개동</td>
					...
					<div style="padding:20px">
						<table bgColor=#C1D2F7 class="detail_table_plus" width = "800"> 
							<tbody ><tr height="30">
								...
								<td><font color="green"> 다소 낮음 (1.5%)</font> </td>	
							</tr>
							<tr height="30">
								<td class="cat">십만 명당 범죄 발생 건수</td>
								<td><font color="green"> 매우 낮음 (5.9건)</font> </td>
							</tr>
