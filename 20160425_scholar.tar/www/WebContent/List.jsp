...
<link rel="stylesheet" type="text/css" href="/safehouse/css/common.css">
<link rel="stylesheet" type="text/css" href="/safehouse/css/ddhouse_mypage.css">
<link rel="stylesheet" type="text/css" href="/safehouse/css/ddhouse_se.css">
<link rel="stylesheet" type="text/css" href="/safehouse/_master/css/custom-theme/jquery-ui-1.10.2.custom.css">
<script async="" src="//www.google-analytics.com/analytics.js"></script><script type="text/javascript" src="/safehouse/_master/js/jquery-1.9.1.min.js"></script>
<script type="text/javascript" src="/safehouse/_master/js/jquery-ui-1.10.2.custom.min.js"></script>
<script type="text/javascript" src="/safehouse/_master/js/jquery-ui-timepicker-addon.js"></script>
<script type="text/javascript" src="/safehouse/_master/js/json2.js"></script>
<script type="text/javascript" src="/safehouse/js/asset_common.js" charset="utf-8"></script>
<script type="text/javascript" src="/safehouse/js/upload_common.js" charset="utf-8"></script>
<script type="text/javascript" src="/safehouse/js/ddhouse_common.js" charset="utf-8"></script>
<script type="text/javascript" src="/safehouse/js/topmenu_border_common.js" charset="utf-8"></script>
...
<div class="content_sub_left">
		...
		<div class="assetlist_wrap no_border_top">
				<div class="bold_letter" style="float:left; padding-left:15px; padding-top:5px; font-size:15px; margin-bottom:18px;">
					<img src="image/house1.PNG" width = "50" height = "50"> 아파트 매물
				</div> 
				<div style="float:right; margin-right:5px; margin-top:10px;">

					<div style="text-align:right; line-height:27px; padding-right:5px">
						<span style="padding-left:15px; cursor:pointer; " onclick="javascript: if(f_check_login()){f_search('set', 'selMyFav', 'Y')}"><input type="checkbox"><img src="/img/icon_new/fav_l.png">관심매물보기</span>
					</div>
				...
				<table class="assetlist2" id="asset_list_tbl">
					...
					<tr style="cursor:pointer; " onclick="f_showmemo2($(this), '234723')" class="firstrow asset_main 234723  even">
						...
						<td class="ta_center no_strike">대도동</td>
						<td>
							<span class="no_strike">동해삼미아파트</span>
								...
								<div class="memo_item">
									...
									<div class="f_left">
										<span class="no_strike" style="max-width: 585px;display: inline-block">
											...
											즉시입주, 남구청맞은편인근,방3, 올리모델링., 융자 없음, (월세1,000/40가능) 
										</span>
									</div>
									<div class="f_right">
									</div>
...
연락주셔요  010-5041-0669
					...
					<tr style="cursor:pointer; " onclick="f_showmemo2($(this), '241495')" class="firstrow asset_main 241495  even">
						<td class="ta_center first_td" style="text-align:left; padding-left:5px;">2015.09.29<span style="padding-left:3px"><img src="/img/icon_new/real_s.png"></span></td>
						<td class="ta_center">매매</td>
				...
				<div class="page">
					 <a href="javascript:f_goPage(1)"><img src="image/pageleft.PNG" height = "20" border="0" alt="첫페이지"></a> <b>1</b> .  <a href="javascript:f_goPage(2)">2</a> .  <a href="javascript:f_goPage(3)">3</a> .  <a href="javascript:f_goPage(4)">4</a> .  <a href="javascript:f_goPage(5)">5</a> .  <a href="javascript:f_goPage(6)">6</a> .  <a href="javascript:f_goPage(7)">7</a> .  <a href="javascript:f_goPage(8)">8</a> .  <a href="javascript:f_goPage(9)">9</a> .  <a href="javascript:f_goPage(10)">10</a> <a href="javascript:f_goPage(11)"><img src="image/pageright.PNG" height = "20" border="0" alt="다음 10 페이지"></a>				
				</div>
