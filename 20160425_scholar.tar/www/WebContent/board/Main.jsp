...
<tr>
  ...
  <td ALIGN="CENTER" style="cursor:pointer" onClick = "javascript:location.replace('MainDday.jsp')"><FONT COLOR=WHITE FACE="Geneva, Arial" SIZE=4> Dday순으로보기 </FONT></td>
    <td ALIGN="CENTER"style="cursor:pointer" onClick = "javascript:location.replace('Write.jsp')"><FONT COLOR=WHITE FACE="Geneva, Arial" SIZE=4> 장학금정보입력 </FONT></td>
...
List<ScholarVO> list = sdao.selectAllBoardRcd(pagenum);
pagenum++;
...
<%}else if(d_day<7 && d_day>=0){%>
	...
	<tr><td> </td></tr>
     <tr align = "center">
     <td align = "center" height=100>
      <FONT COLOR=red FACE="Geneva, Arial" SIZE=10><b> <%=d_day%></b> </FONT></td>
     </tr>
     </table>
     </td>
...
<%}
	...
	<tr><td> </td></tr>
     <tr align = "center">
     <td align = "center" height=100>
     <FONT COLOR=black FACE="Geneva, Arial" SIZE=10> <b> <%=d_day%></b> </FONT></td>
     </tr>
     </table>
     </td>
<%}%>
	...
	<table>
	<tr>
	<td onClick = "javascript:location.replace('Content.jsp?rcdno=<%=vo.getRcdno()%>')"><img style="display:block;"  width = "600" height = "350"src ="<%=image%>"></A></td>
	</tr>
	<tr>
