...
#slides .textCenter {position:absolute; font-size:20px; width:100%; text-align:center; top:200px; color:white; right:0px}
...
.dcp-schedule {position:relative; width:235px; height:231px; padding:20px 0; background:#005b9a; overflow:hidden;}
.dcp-schedule ul {padding:0 20px 0 15px;}
.dcp-schedule li {padding:14px 0;}
.dcp-schedule li a {font-size:16px; color:#fff;}
.dcp-schedule li a span {display:block; text-overflow:ellipsis; overflow:hidden; white-space:nowrap;}
.dcp-schedule li a .date {color:#e8e8e8;}
</style>
</head>
<body>
