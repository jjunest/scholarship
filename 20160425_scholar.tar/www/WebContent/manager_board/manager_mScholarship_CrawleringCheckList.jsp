...
<!-- -----------------Get checkList ScholarList which are in Databases --------------------------- -->
<%
ScholarDAO sdao = ScholarDAO.getInstance();
List<ScholarVO> List = sdao.NeedCheckingInfoList();
%><!-- ----------------- Get checkList ScholarList which are in Databases ENDED---------------------- -->
...
<section id="scC" class="sc scCt scWing">
	<section class="ssBooth ssHighlight">
		<h2 class="h hS2"><span>크롤러</span>체크 페이지</h2>
