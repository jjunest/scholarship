...
<tr><td> ===================================</td></tr>
<tr>
<td>첨부파일 이름------</td><td><input type = text size = 120 placeholder = "장학 재단의 link를 입력하세요 " name ="filename"></td>
</tr>
<tr><td> ===================================</td></tr>
<tr>
<td>첨부파일 url ------</td><td><input type = text size = 120 placeholder = "장학 재단의 link를 입력하세요 " name ="fileurl"></td>
</tr>
<tr><td> ===================================</td></tr>
<tr>
