...
List<ScholarVO> scholarhipList = sdao.selectIngInfo();
%>

<div id="wrap">
<section id="scC" class="sc scCt scWing">
	<section class="ssBooth ssHighlight">
		<h2 class="h hS2"><span>진행</span>장학금</h2>
			<ul class="booth booth1 booth4 listEvenOdd">
			<%for(int i=0; i<scholarhipList.size(); i++){ 
				ScholarVO svo = scholarhipList.get(i);
			%>
			<li>
