...
<td width = 700>
<FONT FACE="Geneva, Arial" SIZE=4><input type="radio" name="gpa" checked="checked" value="1"> 선택안함 </FONT>
...
<FONT FACE="Geneva, Arial" SIZE=4><input type="radio" name="scholarmoney" checked="checked" value="7"> 선택안함 </FONT>
...
<FONT FACE="Geneva, Arial" SIZE=4><input type="radio" name="studentstatus" checked="checked" value="10"> 선택안함 </FONT>
</td>
</tr>

<tr>
<td>schoolname 입력(스트링) </td><td><input type = text size = 100 name ="schoolname"></td>
</tr>
...
<tr>
<td>etc 입력(스트링)</td><td><textarea rows="25" cols="125" name="etc"><h2></h2>
<a href="" target="_blank">공지사항 바로가기</a></textarea></td>
</tr>
